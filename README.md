...
jupyter notebook 3_gradcam_plusplus.ipynb           # LayerCAM (2021)
jupyter notebook 4_adaptive_gradcam_plusplus.ipynb  # Hybrid Grad-LayerCAM (novel)
```
...
**3_gradcam_plusplus.ipynb** (LayerCAM)
- Layer-CAM implementation (2021)
...
**4_adaptive_gradcam_plusplus.ipynb** (Hybrid Grad-LayerCAM)
...
The project uses real CIFAR-10 images downloaded from the test set:
- 20 images across multiple categories (dogs, cats, automobiles, ships, etc.)
- Located in `medical_images/` directory
